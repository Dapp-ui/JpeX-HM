<script lang="ts">
	...
	import { address, displayLongPositions, longPositions, shortPositions } from '$lib/store';

	import { fly } from 'svelte/transition';
	import { quadIn } from 'svelte/easing';
	// @ts-ignore
	import { afterUpdate } from 'svelte';
	import { getActiveLongsForUser, getActiveShortsForUser } from '$lib/db/positions';
...
>
	...
	<!-- Premium collected -->
	<div class=" flex flex-row justify-between p-4 bg-gray-100 rounded-lg font-poppins">
		<div class="flex flex-col">
			...
			<div class=" flex gap-2 items-center mt-1">
				...
				<p class=" text-left  font-semibold text-lg text-[#E137FF]">1.2 ETH</p>
			</div>
		</div>
		<div class="flex flex-col">
			<div>
			...
			<div>
				<p class=" text-right  mt-2 font-semibold text-lg">12.56%</p>
			</div>
		</div>
	</div>
	<!-- Postion & recent tx -->
	<div class=" flex flex-row font-poppins items-center text-[#54587B] font-[500] text-[14px] p-2">
		<div

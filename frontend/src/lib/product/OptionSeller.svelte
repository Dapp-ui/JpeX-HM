<script lang="ts">
	...
	import { getOptionName } from '$lib/utils/helper';
...
<div class=" grid grid-cols-1 gap-2 mt-3">
	...
	<div class="flex flex-row overflow-x-auto font-poppins text-[12px] cursor-pointer">
		{#if $userNFTs != undefined}
			{#each $userNFTs['bayc'] as nft}
				...
				>
					<img class=" rounded-lg object-contain  h-[100px]" src={nft.img} alt="" />
...
<!--  Display premium-->
<div class=" bg-[#F4F9FE] flex justify-center p-2 rounded-lg mt-3 gap-1 items-center">
